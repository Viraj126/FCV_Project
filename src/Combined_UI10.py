...
sift_image = apply_gamma_correction(input_image, 1.4)
...
with col4:
    ...
    st.image(cv2.cvtColor(sift_image, cv2.COLOR_BGR2RGB), channels="RGB", use_column_width=True)
